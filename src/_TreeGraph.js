...
G6.registerEdge('flow-line', {
  draw (cfg, group) {
    ...
    // console.log('cornerPosition', cornerPosition, endPoint.y, 'cornerDirection', cornerDirection)
    ...
    //       ['L', cornerPosition - 20, startPoint.y - 20],
    //       // 折点 转弯完的竖线结束点
    //       ['L', cornerPosition - 20, endPoint.y - 20],
    //       //结束点
